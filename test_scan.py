"""
test_scan.py — backend/url_analyzer scan pipeline smoke test.

Run directly (performs real network scans):
    python test_scan.py

Guarded by __main__ so importing it (e.g. from pytest) has no side effects.
"""
import sys
import time
